...
var View__cmt = function (cmt_id, comment_content) {
    ViewCmtModal.find('.summernote_view_cmt').val(comment_content)
...
$('#del_cmt_confirm_btn').click(function () {
    $.ajax({
        ...
        contentType: "application/json; charset=utf-8",
        data: JSON.stringify({ del_comment_idasdasasd: _idcom }),
        dataType: "json",
        success: function (result) {
            ...
            if (result == true) {
                ...
                Toast.fire({
                    icon: 'success',
                    title: 'Xóa bình luận ' + _idcom + ' thành công'
                })
                setTimeout(function () {
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            if (result == true) {
                ...
                Toast.fire({
                    icon: 'success',
                    title: 'Xóa bình luận ' + _idrepcmt + ' thành công'
                })
                setTimeout(function () {
                    window.location.reload();
                }, 1500);
