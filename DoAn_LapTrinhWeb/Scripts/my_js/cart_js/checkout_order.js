        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (result == true) {
                    ...
                    $(".order_address_content").text(address + ", " + ward_name + ", " + disctric_name + ", " + province_name);
                    const Toast = Swal.mixin({
                        toast: true,
                        position: 'top',
                        showConfirmButton: false,
        ...
        success: function (result) {
            ...
            if (result == true) {
                ...
                $('input[name="account_address_id"]:radio:checked').each(function () {
                    ...
                    _address_content_order = $(this).parent().find('.get_address_content').text();
                });
                $(".ck_username").val(_username_order);
                $(".ck_phone_num").val(_phonenumber_order);
                $(".ck_address").text(_address_content_order);
                const Toast = Swal.mixin({
                    toast: true,
                    position: 'top',
                    showConfirmButton: false,
