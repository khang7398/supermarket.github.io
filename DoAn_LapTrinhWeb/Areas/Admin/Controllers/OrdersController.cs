    ...
    public class OrdersController : BaseController
    {
        ...
        public ActionResult OrderDetails(int? id)
        {
            if (User.Identity.GetRole() == "0" || User.Identity.GetRole() == "2")
            {
                ...
                {
                    Notification.set_flash("Không tồn tại đơn hàng: " + "SPM" + id + ")", "warning");
                    ...
                    ProductOrder += "<tr style='border-bottom: 1px solid rgba(0,0,0,.05);' class='product_item'>" +
                            "<td valign='middle' width ='80%' style='text-align:left; padding:0 2.5em;'> " +
                                "<div class='product-entry'>" +
                                    "<img src='http://puchong0008-001-site1.htempurl.com/" + item.Product.image + "' style = 'width: 100px; max-width: 600px; height: auto; padding-bottom:5px; display: block;'>" +
                                    "<div class='text'>" +
        ...
        public void ExportDataToExcel(DateTime picker1 , DateTime picker2, string order__status,int payment__method)
        {
            ...
            using (ExcelEngine excelEngine = new ExcelEngine())
            {
                ...
                int stt = 0;
                string payment_transaction= "Chưa thanh toán";
                string order_status;
                ...
                row["Trạng thái đơn hàng"] = "Tổng tiền hàng:";
                ...
                workbook.SaveAs("SPM_Report_"+ picker1.ToString("dd-MM-yyyy") + "_" + picker2.ToString("dd-MM-yyyy") + "_" + file + ".xlsx", ExcelSaveType.SaveAsXLS, HttpContext.ApplicationInstance.Response, ExcelDownloadType.Open);
            }
        }
