...
namespace DoAn_LapTrinhWeb.Controllers
{
    public class AccountController : Controller
    {
        ...
        public ActionResult Register([Bind(Exclude = "status,Requestcode")] Account accounts,Register model)
        {
            ...
            {
                accounts.Role = Const.ROLE_MEMBER_CODE;              
                ...
                db.SaveChanges();
                TempData["AccountID"] = accounts.account_id;
                TempData["EmailID"] = accounts.Email;
                return RedirectToAction("EmailverificationRequired", "Account");
            }
        ...
        public ActionResult ForgotPassword(string EmailID)
        {
            string fail = "";
            string success = "";
            var account = db.Accounts.Where(m => m.Email == EmailID && m.status!="2").FirstOrDefault();
            if (account != null)
            {
            ...
            {
                fail = "Email chưa tồn tại trong hệ thống hoặc tài khoản đã bị vô hiệu hóa"; 
            }
            ...
            if (User.Identity.IsAuthenticated)
            {
                ...
                if (orderdetail != null)
                {
                    ...
                    OrderDTOs order = new OrderDTOs
                    {
                        ...
                        order_address_phonenumser = orderdetail.OrderAddress.order_address_phonenumber,
        ...
        [HttpPost]
        public ActionResult ChangeOrderAddress(OrderDTOs model, int id, string address_content, string phonenumber, string username)
        {
            bool result;
            try
            {
